...
describe('getBooleanField', () => {
  it.skip('should return false when eventCfg enabled is false', () => {
    const eventCfg: EventConfig = { enabled: false };
    const result = getBooleanField(eventCfg, undefined, 'enabled', true);
    expect(result).toBe(false);
  });

  it.skip('should return defaultCfg value when eventCfg undefined (line 20)', () => {
  ...
  it.skip('should cover line 20 when defaultCfg is defined but key is undefined', () => {
  ...
  it.skip('should cover defaultCfg !== null branch (line 20)', () => {
    const eventCfg: EventConfig = { enabled: undefined };
    const defaultCfg: EventOverride = { enabled: true };
    const result = getBooleanField(eventCfg, defaultCfg, 'enabled', false);
    expect(result).toBe(true);
  ...
  it.skip('should handle toast key specially', () => {
