...
describe('toast resolution', () => {
  describe('resolveToastOverride', () => {
    it.skip('should return null when toast property is boolean', () => {
  ...
  describe('resolveToastEnabled', () => {
    it.skip('should return false from toast object when enabled is false', () => {
      const eventCfg: EventConfig = { toast: { enabled: false } };
      const result = resolveToastEnabled(eventCfg, undefined);
      expect(result).toBe(false);
    });

    it.skip('should return enabled from toast object when explicitly set to true', () => {
      const eventCfg: EventConfig = { toast: { enabled: true } };
      const result = resolveToastEnabled(eventCfg, undefined);
      expect(result).toBe(true);
    });

    it.skip('should return true from empty toast object', () => {
      const eventCfg: EventConfig = { toast: {} };
      const result = resolveToastEnabled(eventCfg, undefined);
      expect(result).toBe(true);
    });

    it.skip('should use ?? fallback when enabled is explicitly undefined', () => {
    ...
    it.skip('should return boolean when toast is boolean', () => {
      const result = resolveToastEnabled({ toast: true }, undefined);
      expect(result).toBe(true);
    });

    it.skip('should return false when toast is boolean false', () => {
  ...
  describe('resolveDefaultToast', () => {
    it.skip('should return enabled from default toast when boolean false', () => {
      const defaultCfg: EventOverride = { toast: false };
      const result = resolveDefaultToast(defaultCfg);
      expect(result).toBe(false);
    });

    it.skip('should return true when default toast is boolean true', () => {
      const defaultCfg: EventOverride = { toast: true };
      const result = resolveDefaultToast(defaultCfg);
      expect(result).toBe(true);
    });

    it.skip('should return enabled from default toast object when enabled is true', () => {
      const defaultCfg: EventOverride = { toast: { enabled: true } };
      const result = resolveDefaultToast(defaultCfg);
      expect(result).toBe(true);
    });

    it.skip('should return false from default toast object when enabled is false', () => {
      const defaultCfg: EventOverride = { toast: { enabled: false } };
      const result = resolveDefaultToast(defaultCfg);
      expect(result).toBe(false);
    });

    it.skip('should return true when default toast enabled not set', () => {
    ...
    it.skip('should return false when defaultCfg undefined', () => {
      const result = resolveDefaultToast(undefined);
      expect(result).toBe(false);
    });

    it.skip('should return false when default toast undefined', () => {
