...
describe("toast-queue", () => {
  ...
  describe("createToastQueue", () => {
    it("should add toast to queue", () => {
      ...
      queue.add({ title: "Test", message: "Message", variant: "info" as const, duration: 3000 });
    ...
    it("should flush when queue has items", async () => {
      ...
      queue.add({ title: "Test", message: "Message", variant: "info" as const, duration: 10 });
      await queue.flush();
    });
  });
  ...
  describe("showToastStaggered", () => {
    it("should call showFn with toast", async () => {
      const showFn = jest.fn();
      const toast = { title: "Test", message: "Message", variant: "info" as const, duration: 3000 };
