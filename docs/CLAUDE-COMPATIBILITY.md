...
> **Note:** This document is in Portuguese as it serves the Brazilian
> Portuguese-speaking development team. The configuration examples use the
> same TypeScript and JSON syntax as all other docs.
