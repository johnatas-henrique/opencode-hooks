...
This plan was completed. Current coverage is at the configured thresholds (80% statements, 60% branches, 65% functions, 80% lines).
...
// Deve ser:
collectCoverageFrom: ['.opencode/plugins/**/*.ts', '!/**/*.test.ts'];
```
